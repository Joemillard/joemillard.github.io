...
[The Species Awareness Index for 6 taxonomic classes on 10 Wikipedia languages (Millard *et al*. 2021)](Figure_3.png){#id .class width=90% height=90%}

### **Informatics tools in ecology**
</div>

[The geographic distribution of the  pollination literature, according to the frequency of animal species automatically extracted from pollination related abstracts (Millard *et al*. 2020)](abstract_geoparse-major-minor_ratio_14.png){#id .class width=90% height=90%}
